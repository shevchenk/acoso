    ...
    <tr>
        ...
        <td class="header container">
            <div class="content">
                ...
                <tr>
                    <td><img src="{{ asset('Config/user-small.png') }}" height="50px"/></td>
                    <td align="right"><h6 class="collapse"><strong>Formulario de denuncia registrado</strong></h6></td>
                </tr>
            </table>
            </div>
        </td>
                    ...
                    <tr>
                        <td>
                            <p style="text-align:justify !important;">
                                Se ha registrado un nuevo caso con las siguientes referencias:
                            </p>
                            <p style="text-align:justify !important;">
                                Quien registro: {{ $nombre_u.' '.$paterno_u.' '.$materno_u }} 
                            </p>
                            <p style="text-align:justify !important;">
                                Persona afectada: {{ $nombre_a.' '.$paterno_a.' '.$materno_a }} 
                            </p>
                            <p style="text-align:justify !important;">
                                Persona denunciada: {{ $nombre_d.' '.$paterno_d.' '.$materno_d }} 
                            </p>
                            <p style="text-align:justify !important;">
                                El archivo ZIP contiene el formulario firmado en PDF donde se describen los hechos y el archivo de medio probatorio.
                            </p>
                            <p style="text-align:justify !important;">
                                Su contraseña del archivo: {{ $contraseña }}
                            </p>
                            <br>
                            <center>
                                <p style="color:#005486">
                                    <strong>
